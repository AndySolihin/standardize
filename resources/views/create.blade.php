...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_product"
                                        value="Dry Cast Resin" readonly>
                                </div>
                                <div class="mb-3">
                                    <input type="hidden" class="form-control" name="kategori" value="5">
                                </div>
                                <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="selectedValueKapasitas" name="selectedValueKapasitas"
                                        value="">
                                    <select id="coil_lv" name="coil_lv" onchange="showSelected('coil_lv')">
                                        @php

                                            $selectedValue = old('coil_lv');
                                            $selectedValueKapasitas = request('selectedValueKapasitas'); // Menggunakan request() untuk mengambil nilai dari input tersembunyi.
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                // ->where('ukuran_kapasitas', $selectedValueKapasitas)
                                ...
                                <div>
                                    ...
                                    <select id="potong_leadwire" name="potong_leadwire"
                                        ...
                                        @php
                                            $selectedValue = old('potong_leadwire');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'COIL MAKING')
                                ...
                                <div>
                                    <div>
                                        <label>Potong Isolasi</label>
                                        @php
                                            $selectedValues = old('potong_isolasi') ?? []; // Gunakan array untuk menyimpan nilai terpilih
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'COIL MAKING')
                                        ...
                                        @if (count($manhourData) > 0)
                                            @foreach ($manhourData as $data)
                                                <div>
                                                    <input type="checkbox" id="potong_isolasi_{{ $data->nama_tipeproses }}" name="potong_isolasi[]"
                                                           value="{{ $data->nama_tipeproses }}" {{ in_array($data->nama_tipeproses, $selectedValues) ? 'checked' : '' }}>
                                                    <label for="potong_isolasi_{{ $data->nama_tipeproses }}">{{ $data->nama_tipeproses }}</label>
                                                </div>
                                            @endforeach
                                        @else
                                ...
                                <div>
                                    ...
                                    <select id="hv_demoulding" name="hv_demoulding"
                                        ...
                                        @php
                                            $selectedValue = old('hv_demoulding');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'MOULD & CASTING')
                                ...
                                <div>
                                    ...
                                    <select id="type_susun_core" name="type_susun_core"
                                        ...
                                        @php
                                            $selectedValue = old('type_susun_core');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                ...
                                <div>
                                    ...
                                    <select id="instal_housing" name="instal_housing"
                                        ...
                                        @php
                                            $selectedValue = old('instal_housing');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                ...
                                <div>
                                    ...
                                    <select id="bongkar_housing" name="bongkar_housing"
                                        ...
                                        @php
                                            $selectedValue = old('bongkar_housing');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                ...
                                <div>
                                    ...
                                    <select id="pembuatan_cu_link" name="pembuatan_cu_link"
                                        ...
                                        @php
                                            $selectedValue = old('pembuatan_cu_link');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                ...
                                <div>
                                    ...
                                    <select id="potong_isolasi_fiber" name="potong_isolasi_fiber"
                                        ...
                                        @php
                                            $selectedValue = old('potong_isolasi_fiber');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
                                                ->where('nama_workcenter', 'CORE COIL ASSEMBLY')
                                ...
                                <div>
                                    ...
                                    <select id="routine_test" name="routine_test"
                                        ...
                                        @php
                                            $selectedValue = old('routine_test');
                                            $manhourData = $manhour
                                                ->where('nama_kategoriproduk', 'DRY TYPE RESIN')
    ...
    <script type="text/javascript">
        ...
        //         var selectedValueKapasitas = this.value;
        //         $('#selectedValueKapasitas').val(selectedValueKapasitas);

        //         // Mengambil data dari server
        //         $.ajax({
        //             url: '/products/create', // Ganti dengan URL yang sesuai di sisi server
        //             data: {
        //                 selectedValueKapasitas: selectedValueKapasitas
        //             },
        //             dataType: 'json',
        //             success: function(data) {
        //                 updateCoilLVOptions(data);
        //             }
        //         });
        //     });
        //     document.getElementById('ukuran_kapasitas').addEventListener('change', function() {
        //         var selectedValueKapasitas = this.value;
        //         document.getElementById('selectedValueKapasitas').value = selectedValueKapasitas;
        //         updateCoilLVOptions(selectedValueKapasitas);
        //     });

        //     function updateCoilLVOptions(manhourData) {
        //         var coilLVSelect = $('#coil_lv');
        //         // coilLVSelect.empty(); // Menghapus opsi sebelumnya

        //         $.each(manhourData, function(index, data) {
        //             var option = $('<option>', {
        //                 value: data.nama_tipeproses,
        //                 'data-durasi': data.durasi_manhour,
        //                 'data-workcenter': 'COIL MAKING'
        //             }).text(data.nama_tipeproses);

        //             coilLVSelect.append(option);
        //         });
        //     }
        // });
        document.getElementById('ukuran_kapasitas').addEventListener('change', function() {
            var selectedValuekapasitas = this.value;
            document.getElementById('selectedValueKapasitas').value = selectedValuekapasitas;
            console.log(selectedValuekapasitas)
        });
