                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="nomor_so"
                                        value="{{ old('nomor_so', $product->nomor_so) }}" disabled>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Kategori</label>
                                    <input type="text" class="form-control" name="nama_product"
                                        value="{{ old('nama_product', $product->nama_product) }}" disabled>
                                </div>
                                {{-- <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Kapasitas</label>
                                    <select id="ukuran_kapasitas" name="ukuran_kapasitas" class="form-control" disabled>
                                        @php
                                            $selectedValue = old('ukuran_kapasitas', $product->ukuran_kapasitas);
